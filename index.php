                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4" data-index="1">
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            ...
                            <a href="./insert-cart.php?id=<?=$item['id']?>&soluong=1" class="btn btn-sm btn-add-cart text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add to cart</a>
                        </div>
                    </div>
                </div>
            <?php } ?> 
            ...
            ?>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4" data-index="1">
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="./detail.php?id=<?=$item['id']?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                            <a href="./cart.php?id=<?=$item['id']?>" class="btn btn-sm btn-add-cart text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add to cart</a>
                        </div>
                    </div>
                </div>
            <?php } ?> 
